    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PalastranteId = table.Column<int>(type: "INTEGER", nullable: false),
                    EventoId = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    PalestranteEventoPalastranteId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PalestrantesEventos", x => new { x.EventoId, x.PalastranteId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_PalestrantesEventos_PalestrantesEventos_PalestranteEventoEventoId_PalestranteEventoPalastranteId",
                        columns: x => new { x.PalestranteEventoEventoId, x.PalestranteEventoPalastranteId },
                        principalTable: "PalestrantesEventos",
                        principalColumns: new[] { "EventoId", "PalastranteId" },
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PalestrantesEventos_PalestranteEventoEventoId_PalestranteEventoPalastranteId",
                table: "PalestrantesEventos",
                columns: new[] { "PalestranteEventoEventoId", "PalestranteEventoPalastranteId" });
