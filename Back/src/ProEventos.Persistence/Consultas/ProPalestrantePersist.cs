...
namespace ProEventos.Persistence.Consultas
{
    public class ProPalestrantePersist : IPalestrantePersist
    {
        private readonly ProEventosContext _context;
        public ProPalestrantePersist(ProEventosContext context)
        {
            _context = context;
